...
import styles from "./V5Diferencial.module.css";
...
export interface V5DiferencialProps {
  id?: string;
  founderA: Founder;
  founderB: Founder;
  /**
...
export default function V5Diferencial({
  id = "diferencial",
  founderA,
  founderB,
  ...
  /* ============================================================
     ...
     ============================================================ */
  useEffect(() => {
    const TAG = "[V5-Diferencial CardBreath DIAG]";
                ...
                {founder.loopVideo && !reducedMotion ? (
                  <video
                    ...
                    onError={() => {
                      ...
                      console.error(
                        `[V5-Diferencial] ❌ Video for "${founder.name}" failed — ` +
                  ...
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      console.error(
                        `[V5-Diferencial] ❌ Portrait "${founder.name}" load FAILED — ` +
