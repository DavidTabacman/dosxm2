...
| Looks gimmicky to a serious buyer demographic | Cap scale delta at 1.10 and period at ≥8s; hold ease-in-out so the loop never feels mechanical. (Calibrated in two passes after live-site diagnostic showed 1.03 then 1.06 amplitudes were below the perceptibility threshold on a 253×337 frame.) |
